...
async function parseQuery(query) {
  const { parse: parse4 } = await import("./graphql-SWGILAL4.js").catch((error) => {
...
var _a3, _b;
var HttpResponse = class _HttpResponse extends (_b = FetchResponse, _a3 = bodyType, _b) {
  constructor(body, init) {
...
sendMessage_fn = function(message2) {
  ...
  __privateGet(this, _emitter2).emit("message", {
    id: message2.id,
    event: ((_a6 = message2.event) == null ? void 0 : _a6.toString()) || "message",
    data: message2.data,
    frames
  });
};
...
var _ObservableEventSource = class _ObservableEventSource extends (_i = EventTarget, _h = kRequest, _g = kReconnectionTime, _f = kLastEventId, _e = kAbortController, _d = kOnOpen, _c = kOnMessage, _b2 = kOnAnyMessage, _a5 = kOnError, _i) {
