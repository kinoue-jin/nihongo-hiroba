  ...
  */
  send(data) {
    ...
    queueMicrotask(() => {
      var _a12;
      this.bufferedAmount = 0;
      (_a12 = this[kOnSend]) == null ? void 0 : _a12.call(this, data);
    });
  }
...
}, _a2.symbol = Symbol("websocket"), _a2);
...
var DeferredPromise2 = (_a3 = class extends Promise {
...
function enableMocking(context, options) {
  ...
  context.workerChannel.once("MOCKING_ENABLED", async (event) => {
    ...
    printStartMessage({
      quiet: options.quiet,
      workerScope: (_a12 = context.registration) == null ? void 0 : _a12.scope,
...
function getVariable(variableName) {
  ...
  return (_a12 = globalThis[variableName]) == null ? void 0 : _a12.toString();
}
...
var Interceptor2 = class {
  ...
  */
  ...
  getInstance() {
    ...
    this.logger.info("retrieved global instance:", (_a12 = instance == null ? void 0 : instance.constructor) == null ? void 0 : _a12.name);
    return instance;
  }
  setInstance() {
...
function createResponseListener(context) {
  return (event) => {
    ...
    if ((_a12 = responseMessage.response.type) == null ? void 0 : _a12.includes("opaque")) {
      return;
    }
...
var TypedEvent = (_e = class extends (_d = MessageEvent, _c = kDefaultPrevented2, _b = kPropagationStopped, _a7 = kImmediatePropagationStopped, _d) {
  constructor(...args) {
    super(args[0], args[1]);
    /**
...
var Emitter2 = (_a8 = class {
  ...
  */
  ...
  if ((_a12 = listener[kListenerOptions]) == null ? void 0 : _a12.once) {
...
var _a10;
var FetchInterceptor = (_a10 = class extends Interceptor2 {
  constructor() {
    super(_a10.symbol);
  }
  checkEnvironment() {
      ...
      methodCall: ([methodName, args], invoke) => {
        switch (methodName) {
          ...
          case "send": {
            ...
            queueMicrotask(() => {
              var _a12;
              (((_a12 = this.onRequest) == null ? void 0 : _a12.call(this, {
                request: fetchRequest,
                requestId: this.requestId
...
var _a11;
var XMLHttpRequestInterceptor = (_a11 = class extends Interceptor2 {
  constructor() {
    super(_a11.interceptorSymbol);
  }
  checkEnvironment() {
...
}, _a11.interceptorSymbol = Symbol("xhr"), _a11);
...
var SetupWorkerApi = class extends SetupApi {
  ...
  stop() {
    ...
    window.postMessage({ type: "msw/worker:stop" });
    printStopMessage({
      quiet: (_a12 = this.context.startOptions) == null ? void 0 : _a12.quiet
    });
  }
};
